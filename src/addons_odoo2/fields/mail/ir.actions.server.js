const ModelFields = {
  ...
  activity_note: { placeholder: 'Log a note...' },
  activity_summary: { placeholder: 'e.g. Discuss proposal' },
  activity_type_id: { required: [['state', '=', 'next_activity']] },
  activity_user_field_name: { required: [['state', '=', 'next_activity'], ['activity_user_type', '=', 'generic']] },
  activity_user_id: { required: [['state', '=', 'next_activity'], ['activity_user_type', '=', 'specific']] },
  activity_user_type: { required: [['state', '=', 'next_activity']] },
  mail_post_autofollow: {},
  mail_post_method: { required: [['state', '=', 'mail_post']] },
  partner_ids: {},
  template_id: {
