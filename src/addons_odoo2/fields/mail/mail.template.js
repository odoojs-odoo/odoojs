const ModelFields = {
  attachment_ids: {},
  auto_delete: {},
  body_html: { readonly: [['can_write', '=', false], ['id', '!=', false]] },
  can_write: {},
  description: {},
  email_cc: { placeholder: 'Comma-separated carbon copy recipients addresses' },
  email_from: { placeholder: "Override author's email" },
  email_to: { placeholder: 'Comma-separated recipient addresses' },
  ...
  partner_to: { placeholder: 'Comma-separated ids of recipient partners' },
  ref_ir_act_window: {},
