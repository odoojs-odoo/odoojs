const ModelFields = {
  ...
  currency_id: {},
  date_planned: { required: [['display_type', '=', false]] },
  display_type: {},
  invoice_lines: {},
  name: {},
  price_subtotal: {},
  ...
  product_uom_$_tree_$$_431: { groups: 'uom.group_uom' },
  product_uom_$_tree_$$_499: { groups: '!uom.group_uom' },
  product_uom_category_id: {},
  qty_invoiced: { string: '===todo==' },
  qty_invoiced_$_form: { string: 'Billed Quantity' },
  qty_invoiced_$_tree: { string: 'Billed' },
  qty_received: {
    string: '===todo==',
    readonly: [['qty_received_method', '!=', 'manual']]
  },

  qty_received_$_form: { string: 'Received Quantity' },
  qty_received_$_tree: { string: 'Received' },
  qty_received_manual: {},
  qty_received_method: {},
  sequence: {},
  state: {},
