const ModelFields = {
  ...
  currency_id_$_form_$$_624: { groups: 'base.group_multi_currency' },
  currency_id_$_form_$$_879: { groups: '!base.group_multi_currency' },
  date_approve: {},
  date_order: {},
  date_planned: { readonly: [['state', 'not in', ('draft', 'sent', 'to approve', 'purchase')]] },
  fiscal_position_id: { readonly: ['|', ['invoice_status', '=', 'invoiced'], ['state', '=', 'done']] },
  id: {},
  invoice_count: { string: 'Vendor Bills' },
  invoice_ids: {},
  invoice_status: {},
  ...
  partner_ref: {},
  payment_term_id: { readonly: ['|', ['invoice_status', '=', 'invoiced'], ['state', '=', 'done']] },
  priority: {},
