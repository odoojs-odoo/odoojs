const ModelFields = {
  ...
  partner_bank_id_$_form_$$_172: { string: 'Customer Bank Account' },
  partner_bank_id_$_form_$$_264: { string: 'Vendor Bank Account' },
  partner_bank_id_$_form_$$_720: { string: 'Company Bank Account' },
  partner_id: {
    string: '===todo==',
    readonly: [['state', '!=', 'draft']],
  ...
  partner_id_$_form_$$_472: { string: 'Customer' },
  partner_id_$_form_$$_744: { string: 'Vendor' },
  partner_id_$_tree_$$_931: { string: 'Customer' },
  partner_type: {},
  payment_method_code: {},
