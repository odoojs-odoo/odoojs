const ModelFields = {
  ...
  product_uom_id_$_form_$$_267: {
    string: 'Unit of Measure'
  },

  product_uom_id_$_form_$$_359: {
    string: 'Unit of Measure'
  },

  product_uom_id_$_tree_$$_114: {
    string: 'Unit'
  },

  product_uom_id_$_tree_$$_564: {
    string: 'Unit of Measure'
  },

  product_uom_id_$_tree_$$_941: {
    string: 'Unit of Measure',
    readonly: ['|', '|', ['reserved_uom_qty', '!=', 0.0], '&', ['package_level_id', '!=', false], ['parent.picking_type_entire_packs', '=', true], '&', ['state', '=', 'done'], ['id', '!=', false]]
  },

  product_uom_id_$_tree_$$_748: {
