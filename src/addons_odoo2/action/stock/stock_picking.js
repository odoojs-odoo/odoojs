  ...
  view_picking_form: {
    ...
    arch: {
      header: {
        ...
        _button_action_toggle_is_locked_527: {
          _attr: {
            name: 'action_toggle_is_locked',
            type: 'object',
            string: 'Lock',
        ...
        _group: {
          _group: {
            _div: {
              ...
              _label_partner_id_173: {
                for: 'partner_id',
                string: 'Receive From',
                invisible: [['picking_type_code', '!=', 'incoming']]
              },
              _label_partner_id_373: {
                for: 'partner_id',
                string: 'Contact',
                ...
                tree: {
                  arch: {
                    sheet: {
                      ...
                      _button_action_product_forecast_report_562: {
                        _attr: {
                          name: 'action_product_forecast_report',
                          type: 'object',
                          title: 'Forecast Report',
