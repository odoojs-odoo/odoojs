  ...
  view_stock_move_line_detailed_operation_tree: {
    ...
    arch: {
      sheet: {
        ...
        _field_package_id_960: {
          package_id: { groups: 'stock.group_tracking_lot' }
        },
        _field_result_package_id_871: {
