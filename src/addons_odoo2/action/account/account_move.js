  ...
  view_invoice_tree: {
    ...
    arch: {
      sheet: {
        ...
        _field_invoice_partner_display_name_644: {
          invoice_partner_display_name: {
            string: 'Customer',
            groups: 'base.group_user',
    ...
    arch: {
      sheet: {
        _header: {
          ...
          _button_action_invoice_sent_640: {
            _attr: {
              name: 'action_invoice_sent',
              type: 'object',
              string: 'Send & Print',
