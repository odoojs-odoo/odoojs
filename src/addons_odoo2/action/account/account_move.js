  ...
  view_invoice_tree: {
    ...
    arch: {
      sheet: {
        ...
        _field_invoice_partner_display_name_747: {
          invoice_partner_display_name: {
            string: 'Customer',
            groups: 'base.group_user',
  ...
  view_move_form: {
    ...
    arch: {
      header: {
        ...
        _button_action_invoice_sent_833: {
          _attr: {
            name: 'action_invoice_sent',
            type: 'object',
            string: 'Send & Print',
