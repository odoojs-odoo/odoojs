...
export class ExtendModel extends Model {
  ...
  static async get_echart_option_report() {
    ...
    // const years = [...new Set(json_data.map(item => item[4]).slice(1))].sort()
    ...
    const option = {
      odoojs_echarts_type: {
        ...
        label: [['graphic', 'elements', [0], 'style', 'text']]
      },
  ...
  static async get_echart_data_report() {
    // const _rawData = json_data

    // const datasetWithFilters = countries.map(country => {
    //   return {
    //     id: 'dataset_' + country,
...
const AddonsModels = {
  'odoojs.echarts.bar.race.demo2': ExtendModel
}
