...
export class ExtendModel extends Model {
      ...
      series: [
        {
          ...
          markLine: {
            symbol: ['none', 'none'],
            label: { show: false },
            lineStyle: { color: '#e54035', width: 2 },
            data: [{ yAxis: 8844 }]
          }
        },
        {
          ...
          z: -10,
          data: [
            { value: 1, symbolSize: ['150%', 50] },
            { value: '-' },
            { value: 1, symbolSize: ['200%', 50] },
            { value: 1, symbolSize: ['200%', 50] }
          ]
        }
      ]
  ...
  static async get_echart_option_spirits() {
    const spirit =
  ...
  static async get_echart_data_spirits() {
    return {
      //   dimensions: ['product', 'amount', 'tax', 'total'],
      //   source
    }
  ...
  static async get_echart_option(report) {
    const maps = {
      ...
      spirits: 'get_echart_option_spirits'
    }
  ...
  static async get_echart_data(report) {
    const maps = {
      ...
      spirits: 'get_echart_data_spirits'
    }
    return this[maps[report]]()
  }
}
...
const AddonsModels = {
  'odoojs.echarts.pictorialbar': ExtendModel
}
