    ...
    static async echart_run_report4(myChart) {
      const option = {
        ...
        globe: {
          ...
          realisticMaterial: {
            // roughness:
            //   this.ROOT_PATH + '/asset/get/s/data-1497599804873-H1SHkG-mZ.jpg',
            // metalness:
            //   this.ROOT_PATH + '/asset/get/s/data-1497599800643-BJbHyGWQW.jpg',
            textureTiling: [8, 4]
          },
          postEffect: { enable: true },
...
const AddonsModels = {
  'odoojs.echarts.globe': ModelCreator
}
