...
const reports_pie_radar_funnel = [
...
const reports_sankey_scatter_sunburst_surface = [
...
const reports_heatmap_graph = [
  ...
  { type: 'graph', name: 'graphgl', code: 'odoojs.echarts.graphgl,report' }
]
...
const reports_3d = [
  ...
  { type: 'line3d', name: 'line3d', code: 'odoojs.echarts.line3d,report' },
  { type: 'lines3d', name: 'lines3d', code: 'odoojs.echarts.lines3d,report' },
...
const reports = [
  ...
  ...reports0,
  ...reports_bar,
  ...reports_line_parallel,
  ...reports_gauge,
  ...reports_3d,
  ...reports_tree,
  ...reports_pie_radar_funnel,
  ...reports_sankey_scatter_sunburst_surface,
  ...reports_themeriver,
  ...reports_heatmap_graph,
