...
const test_action = async () => {
  ...
  const xml_id = 'account.action_move_journal_line'
  ...
  // const m2o = records.$$journal_id
  // console.log('1 m2o', m2o)

  console.log('1 _view_fields', view._view_fields)

  // const node = view.node_get('journal_id')
  // console.log('1 node_journal_id', node)

  // const ops = await records.get_selection('journal_id', {
  //   name: '',
  //   domain: node.attrs.domain,
  //   context: node.attrs.context
  // })

  // console.log('ops node_journal_id', ops)

  const line = await records.$$line_ids
