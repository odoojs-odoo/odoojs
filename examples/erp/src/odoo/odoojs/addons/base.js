...
const res_users_template = {
  ...
  formview: [
    {
      title: '基本信息',
      columns: [{ title: '账号', dataIndex: 'login' }, { title: '名称', dataIndex: 'name' }],
    },
    {
      title: '',
      columns: [],
...
const res_partner_template = {
  formview: [
    ...
    },
    {
      ...
      columns: [
        ...
        { title: 'child_ids', dataIndex: 'child_ids', type: 'one2many', relation: 'res.partner' },
      ],
    },
  ],
  ...
  treeview: [{ title: '名称', dataIndex: 'name' }, { title: 'ref', dataIndex: 'ref' }],
};
...
export default {
  ...
  models: {
    ...
    'res.partner.category': {
      fields: ['name', 'color', 'parent_id', 'child_ids', 'active', 'parent_path', 'partner_ids'],
    },
