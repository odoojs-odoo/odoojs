  ...
  columns = [
    {
      ...
      dataIndex: '_',
      render: (_, { id }) => {
        return <Link to={`/BackProject/Work?id=${id}`}>查看</Link>;
      },
    },
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Modal title="新建节点" visible={visible} onOk={this.handleOk} onCancel={this.handleCancel}>
          <Form>
              ...
              {getFieldDecorator('project_id', {
                ...
                <Select placeholder="请选择所属项目">
                  {projectsList.map(project => {
                    return (
                      <Option value={project.id} key="id">
                        {project.name}
                      </Option>
                    );
                  })}
