...
import zog_igame from '../odoo.addons.zog_igame';
...
const get_odoo = () => {
  ...
  const modules = { zog_igame, crm, project, product, analytic, account };
...
const test1 = async done => {
  ...
  console.log('product.product', odoo._env['product.product']._fields_raw);
  console.log(
    'account.analytic.account',
    odoo._env['account.analytic.account']._fields_raw
  );
