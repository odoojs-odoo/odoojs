...
const test_pm = async done => {
  ...
  const prj = await pm_create_project_with_user(
    odoo,
    comp,
    prj_name,
    user_name
...
const pm_create_project_with_user = async (
  odoo,
  comp0,
  prj_name,
  user_name
...
const pm_create_user = async (odoo, user_name) => {
  ...
  const me1 = me.look({
    login: 0,
    company_id: { name: 0, company_registry: 0 },
  });
...
const test_project = async odoo => {
  const prj = await find_or_create(
    odoo,
    'project.project',
    [['code', '=', '1']],
    { code: '1', name: '项目1' }
  ...
  const work1 = await find_or_create(
    odoo,
    'project.work',
  ...
  const work2 = await find_or_create(
    odoo,
    'project.work',
  ...
  const work3 = await find_or_create(
    odoo,
    'project.work',
  ...
  const work41 = await find_or_create(
    odoo,
    'project.work',
  ...
  const work42 = await find_or_create(
    odoo,
    'project.work',
  ...
  const work43 = await find_or_create(
    odoo,
    'project.work',
...
const test_worksheet = async odoo => {
  const prj = await search_one(odoo, 'project.project', [['code', '=', '1']]);
  const prj_id = prj.attr('id');

  const work = await search_one(
    odoo,
    'project.work',
    //        [['code','=','1.1.1'],['project_id','=', prj_id]]
  ...
  const worksheet = await find_or_create(
    odoo,
    'project.worksheet',
